...
class LinExpr:
    ...
    @overload  # type: ignore  # used as constraint sense, not comparison
...
class MLinExpr:
    ...
    @overload
    def __ge__(self, other: np.ndarray) -> TempMConstr: ...
    @overload
    ...
    @overload
    def __le__(self, other: np.ndarray) -> TempMConstr: ...
...
class Model:
    ...
    def addVars(
        ...
        *,
        ...
        obj: Union[float, Sequence[float]] = 0.0,
    ...
    def addVars(
        ...
        *,
        ...
        obj: Union[float, Mapping[_Scalar, float]] = 0.0,
    ...
    def getA(self) -> Any: ...  # no type hinting for scipy.sparse
    @overload
    def getAttr(self, attrname: str) -> _Scalar: ...
    @overload
    def getAttr(
...
class tupledict(Dict[_T, _U]):
    def clean(self) -> None: ...
    def keys(self) -> tuplelist[_T]: ...  # type: ignore  # expects KeysView
    def prod(
        self,
    ...
    def values(self) -> List[_U]: ...  # type: ignore  # expects ValuesView
